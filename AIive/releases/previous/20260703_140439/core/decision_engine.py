...
- 完成任务 (complete_task)：完成 self_development/issues.md 中的 Open 状态任务
...
6. 当用户要求"完成 issue"、"完成任务"、"处理待办"等时，应选择 complete_task 类型
7. complete_task 类型需要：读取 issues.md，分析 Open 状态任务，生成代码修改操作，更新任务状态"""
...
{
  "request_type": "chat | memory_update | persona_update | listen_policy_update | capability_change | code_change | docs_update | self_improvement | complete_task",
