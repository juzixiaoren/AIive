...
class TestAsyncMemoryExtraction:
    def test_chat_enqueues_memory_jobs(self, db_session):
        ...
        for j in jobs:
            assert j.status in ("pending", "completed")  # auto-processed now

    def test_memory_and_steward_both_enqueued(self, db_session):
    ...
    def test_jobs_have_correct_payload(self, db_session):
